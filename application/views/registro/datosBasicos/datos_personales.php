        ...
        <form action="" method="post">
            ...
            <div class="col">
                <div class="form-outline">
                    ...
                    <input type="text" id="numero_documento" name="numero_documento" class="form-control" value="<?=$info_paciente[0]['numero_documento']?>"/>
                </div>
            </div>
            </div>
            ...
            <div class="col">
                <div class="form-outline">
                    ...
                    <input type="text" id="nombres" name="nombres" class="form-control" value="<?=$info_paciente[0]['nombres']?>"/>
                </div>
            </div>
            <div class="col">
                <div class="form-outline">
                    <label class="form-label" for="apelidos">Apellidos</label>
                    <input type="text" id="apellidos" name="apellidos" class="form-control" value="<?=$info_paciente[0]['apellidos']?>"/>
                </div>
            </div>
            </div>
            <div class="row align-items-end mb-4">
            ...
            <div class="col">
                <div class="form-outline">
                    ...
                    <input type="date" id="fecha_nac" name="fecha_nac" class="form-control" value="<?=$info_paciente[0]['fecha_nac']?>"/>
                </div>
            </div>
            <div class="col">
                <!-- Text input -->
                ...
                <div class="form-outline">
                    ...
                    <input type="number" id="telefono" name="telefono" class="form-control" value="<?=$info_paciente[0]['telefono']?>"/>
                </div>
            </div>
            </div>
