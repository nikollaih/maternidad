               ...
               <div class="card-body">
                  <form>
                     <div class="row mb-4">
                        ...
                        <div class="col">
                           <div class="form-outline">
                              <label class="form-label" for="form6Example1">Causales</label>
                              <select class="select form-control">
                                 <option value="1">One</option>
                                 <option value="2">Two</option>
                                 <option value="3">Three</option>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="row mb-4">
                           ...
                           <div class="col">
                              <div class="form-outline">
                                 <label class="form-label" for="form6Example1">Fecha de terminación del embarazo</label>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col">
                              <div class="form-outline">
                                 <label class="form-label" for="form6Example1">Tipo</label>
                                 <select class="select form-control">
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
