         ...
         <div class="row ">
               <div class="col-md-4 col-sm-12 mb-4">
                  <div class="form-outline">
                        ...
                        <select class="select form-control" id="dimension" name="dimension">
               ...
               <div class="col-md-4 col-sm-12 mb-4">
                  <div class="form-outline">
                        <label class="form-label" for="causal">Causales</label>
                        <select class="select form-control" id="causal" name="causal">
                           <option value="">-- Seleccionar</option>
                           <?php
                              if($tipo_causales){
